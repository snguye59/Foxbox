...
const ComponentsPage = () => {
  const links = [
    ...
    { href: "/sandbox/components/inputs", label: "Inputs" },
    ...
    { href: "/sandbox/components/modals", label: "Modals" },
    { href: "/sandbox/components/forms", label: "Forms" },
    { href: "/sandbox/components/navigations", label: "Navigations" },
    { href: "/sandbox/components/widgets", label: "Widgets" },
